...
//
    ...
    enum {
        //change by wenbin 20150107
        MASLayoutPriorityRequired = 1000, //UILayoutPriorityRequired
        MASLayoutPriorityDefaultHigh = 750, //UILayoutPriorityDefaultHigh
        MASLayoutPriorityDefaultMedium = 500,
        MASLayoutPriorityDefaultLow = 250, //UILayoutPriorityDefaultLow
        MASLayoutPriorityFittingSizeLevel = 50, //UILayoutPriorityFittingSizeLevel
    };
